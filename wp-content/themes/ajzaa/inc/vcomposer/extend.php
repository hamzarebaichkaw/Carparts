...
$ajzaa_fonts_array = unserialize($fontsSeraliazed);
...
$vc_add_css_animation = array(
	'type' => 'dropdown',
	'heading' => esc_html__( 'CSS Animation', 'ajzaa' ),
	'param_name' => 'css_animation',
	'admin_label' => true,
	'value' => array(
		esc_html__( 'No', 'ajzaa' ) => '',
		esc_html__('Expand In', 'ajzaa' ) => 'expandIn',
		esc_html__('Bounce In', 'ajzaa' ) => 'bounceIn',
		esc_html__('Bounce In Down', 'ajzaa' ) => 'bounceInDown',
		esc_html__('Bounce In Left', 'ajzaa' ) => 'bounceInLeft',
		esc_html__('Bounce In Right', 'ajzaa' ) => 'bounceInRight',
		esc_html__('Bounce In Up', 'ajzaa' ) => 'bounceInUp',
		esc_html__('Fade In', 'ajzaa' ) => 'fadeIn',
		esc_html__('Fade In Down', 'ajzaa' ) => 'fadeInDown',
		esc_html__('Fade In Down Big', 'ajzaa' ) => 'fadeInDownBig',
		esc_html__('Fade In Left', 'ajzaa' ) => 'fadeInLeft',
		esc_html__('Fade In Left Big', 'ajzaa' ) => 'fadeInLeftBig',
		esc_html__('Fade In Right', 'ajzaa' ) => 'fadeInRight',
		esc_html__('Fade In Right Big', 'ajzaa' ) => 'fadeInRightBig',
		esc_html__('Fade In Up', 'ajzaa' ) => 'fadeInUp',
		esc_html__('Fade In Up Big', 'ajzaa' ) => 'fadeInUpBig',
		esc_html__('Flip', 'ajzaa' ) => 'flip',
		esc_html__('Flip In X', 'ajzaa' ) => 'flipInX',
		esc_html__('Flip In Y', 'ajzaa' ) => 'flipInY',
		esc_html__('Flip Out X', 'ajzaa' ) => 'flipOutX',
		esc_html__('Flip Out Y', 'ajzaa' ) => 'flipOutY',
		esc_html__('Light Speed In', 'ajzaa' ) => 'lightSpeedIn',
		esc_html__('Light Speed Out', 'ajzaa' ) => 'lightSpeedOut',
		esc_html__('Rotate In', 'ajzaa' ) => 'rotateIn',
		esc_html__('Rotate In Down Left', 'ajzaa' ) => 'rotateInDownLeft',
		esc_html__('Rotate In Down Right', 'ajzaa' ) => 'rotateInDownRight',
		esc_html__('Rotate In Up Left', 'ajzaa' ) => 'rotateInUpLeft',
		esc_html__('Rotate In Up Right', 'ajzaa' ) => 'rotateInUpRight',
		esc_html__('Slide In Up', 'ajzaa' ) => 'slideInUp',
		esc_html__('Slide In Down', 'ajzaa' ) => 'slideInDown',
		esc_html__('Slide In Left', 'ajzaa' ) => 'slideInLeft',
		esc_html__('Slide In Right', 'ajzaa' ) => 'slideInRight',
		esc_html__('Zoom In ', 'ajzaa' ) => 'zoomIn',
		esc_html__('Zoom In Down', 'ajzaa' ) => 'zoomInDown',
		esc_html__('Zoom In Left', 'ajzaa' ) => 'zoomInLeft',
		esc_html__('Zoom In Right', 'ajzaa' ) => 'zoomInRight',
		esc_html__('Zoom In Up', 'ajzaa' ) => 'zoomInUp',
		esc_html__('Roll In', 'ajzaa' ) => 'rollIn',
	),
	'description' => esc_html__( 'Select type of animation for element to be animated when it "enters" the browsers viewport (Note: works only in modern browsers).', 'ajzaa' )
);
...
get_template_part('inc/vcomposer/vc_elements/wd-car_suppliers');
...
get_template_part('inc/vcomposer/vc_elements/wd_product_cat');
...
vc_add_param("vc_row",
	array(
		...
		'description' => esc_html__( 'Select font color', 'ajzaa' ),
	)
);
